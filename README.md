...
Instructions for provisioning databases, loading the dataset, running workloads, and generating results will be documented here.

## Results

Results will be added after the benchmark runs are completed.